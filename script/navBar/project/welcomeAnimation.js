...
let welcomeAnimationArray = [
    ["creatorContainerShow", 
        [theProjectName, 1, 0, ftheProjectName, 0], 
        [myKnowledge, 1, 0, fmyKnowledge, 0], 
        [myPersonalInformation, 1, 0, fmyPersonalInformation, 0]], 

    ["iconWelcomeShow", 
        [iconMainBar01, 1, 0, iconsGoDownOrUp, 4], 
        [iconMainBar02, 1, 0, iconsGoDownOrUp, 6], 
        [iconMainBar03, 1, 0, iconsGoDownOrUp, 2], 
        [iconMainBar04, 1, 0, iconsGoDownOrUp, 1.7], 
        [iconMainBar05, 1, 0, iconsGoDownOrUp, 1.15], 
        [iconMainBar06, 1, 0, iconsGoDownOrUp, 1.3], 
        [iconMainBar07, 1, 0, iconsGoDownOrUp, 1.5], 
        [iconMainBar08, 1, 0, iconsGoDownOrUp, 17.3], 
        [myprofilePic, 1, 0, iconsGoDownOrUp, 0]], 

    ["iconWelcomeHidden", 
        [iconMainBar01, 0, 0, iconsGoDownOrUp, 0], 
        [iconMainBar02, 0, 0, iconsGoDownOrUp, 0], 
        [iconMainBar03, 0, 0, iconsGoDownOrUp, 0], 
        [iconMainBar04, 0, 0, iconsGoDownOrUp, 0], 
        [iconMainBar05, 0, 0, iconsGoDownOrUp, 0], 
        [iconMainBar06, 0, 0, iconsGoDownOrUp, 0], 
        [iconMainBar07, 0, 0, iconsGoDownOrUp, 0], 
        [iconMainBar08, 0, 0, iconsGoDownOrUp, 0], 
        [myprofilePic, 0, 0, iconsGoDownOrUp, 0]], 

    ["creatorContainerMoveUp", 
        [theProjectName, 0, 0, moveTheProjectName, 0], 
        [myKnowledge, 0, 0, moveMyKnowledge, 0], 
        [myPersonalInformation, 0, 0, moveMyPersonalInformation, 0]], 

    ["backgroundColorOpicityChange", 
        [null, 4, 0, closeWelcomeDivContainer, 0]], 

    ["iconWelcomeBottonShow", 
        [iconMainBar01, 1, 0, iconsBottomShow, 4, 40, -270], 
        [iconMainBar02, 1, 0, iconsBottomShow, 4, 40, -210], 
        [iconMainBar03, 1, 0, iconsBottomShow, 4, 40, -150], 
        [iconMainBar04, 1, 0, iconsBottomShow, 4, 40, -90], 
        [iconMainBar05, 1, 0, iconsBottomShow, 4, 40, -30], 
        [iconMainBar06, 1, 0, iconsBottomShow, 4, 100, 30], 
        [iconMainBar07, 1, 0, iconsBottomShow, 4, 60, 150], 
        [iconMainBar08, 1, 0, iconsBottomShow, 1, 40, 230]],
    ["loadingRemoved", 
        [loadingToRemove, 0, loadingLogoRemove, loadingLogoRemoveOpacity]],
    ["releaseScreenToScrolling",
        [null, 0, releaseScreenScrolling]],
    ["closeWelcomeContainer",
        [null, 0, closeWelcomeScreenContainer]]
];
...
setTimeout(() => {
    mainIndexId.style.opacity = '1';
    navTabMain.style.opacity = '1';
}, 0);
...
setTimeout(showNavBar, 0 * 1000);


function goAboutMe() {
    window.location = "../../mainPageAfter.html#aboutMeJump";

}

function goMyProject() {
    window.location = "../../mainPageAfter.html#myProjectJump";
}

function goContactMe() {
    window.location = "../../mainPageAfter.html#contactJump";
}
